...
public class GameController : MonoBehaviour {
	...
	public float cubeChallengePlaceSpeed = 0.5f;
	...
	IEnumerator ShowCubePlace() {
		while(true) {
			SpawnPositions();
			yield return new WaitForSeconds(cubeChallengePlaceSpeed);
	...
	private void SpawnPositions(){
		...
		cubeToPlace.positions = positions[UnityEngine.Random.Range(0, pos.Count)];
...
struct CubePos {
	...
	public void setVector(Vector3 targetPos) {
